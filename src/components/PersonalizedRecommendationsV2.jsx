...
export const PersonalizedRecommendationsV2 = forwardRef((props, ref) => {
  const {
    currentUser,
    isAuthenticated,
    propUserPreferences,
  ...
  const fetchRecommendations = useCallback(async (forceRefresh = false) => {
    ...
    try {
      ...
      // Get user preferences from props or localStorage
...
PersonalizedRecommendationsV2.displayName = 'PersonalizedRecommendationsV2';

export default PersonalizedRecommendationsV2;