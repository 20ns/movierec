  ...
  return (
    <div className="w-full h-screen max-w-7xl mx-auto px-4 relative z-10 flex flex-col">
      <motion.div
        ...
        animate={{ paddingTop: hasSearched ? '2rem' : '0', paddingBottom: hasSearched ? '2rem' : '0' }}
        transition={{ type: 'spring', stiffness: 300 }}
      >
        <motion.div
          className="w-full max-w-3xl"
          animate={{ y: hasSearched ? 40 : 0, scale: hasSearched ? 0.95 : 1 }}
          transition={{ type: 'spring', stiffness: 300 }}
        >
          <motion.form
            ...
            animate={{
              ...
              boxShadow: isFocused ? '0 8px 30px rgba(98, 102, 241, 0.2)' : '0 4px 6px rgba(0, 0, 0, 0.1)'
            }}
            transition={{ type: 'spring', stiffness: 300 }}
          >
